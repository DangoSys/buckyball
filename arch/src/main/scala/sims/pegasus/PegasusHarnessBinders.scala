...
class WithPegasusAXIMem extends HarnessBinder({
...
class WithPegasusUART extends HarnessBinder({
...
class WithPegasusTiedOffJTAG extends HarnessBinder({
...
class WithPegasusTiedOffDMI extends HarnessBinder({
...
class WithPegasusHarness extends Config(

package examples.konbi.tiles.konbitile.prefillcore.balldomain.configs
...
object BallDomainConfig {
  private val path =
    "src/main/scala/examples/konbi/tiles/konbitile/prefillcore/balldomain/configs/default.json"

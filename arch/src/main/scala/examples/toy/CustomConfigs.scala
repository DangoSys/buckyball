...
class WithLargeBootROM(address: BigInt = 0x80000, size: Int = 0x80000) extends Config((site, here, up) => {
...
class BuckyballToy4Config extends Config(
...
class BuckyballToy64Config extends Config(
  new WithLargeBootROM(0x80000, 0x80000) ++
  new constellation.soc.WithSbusNoC(constellation.protocol.SimpleTLNoCParams(
    constellation.protocol.DiplomaticNetworkNodeMapping(
      inNodeMapping = ListMap(
...
class BuckyballToy256Config extends Config(
  new WithLargeBootROM(0x80000, 0x80000) ++
  new constellation.soc.WithSbusNoC(constellation.protocol.SimpleTLNoCParams(
    constellation.protocol.DiplomaticNetworkNodeMapping(
      inNodeMapping = ListMap(

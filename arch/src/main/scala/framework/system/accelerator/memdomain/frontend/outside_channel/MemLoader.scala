package framework.system.accelerator.memdomain.frontend.outside_channel

import chisel3._
import chisel3.util._
import framework.system.accelerator.memdomain.frontend.cmd_channel.rs.{MemRsComplete, MemRsIssue}
import framework.system.accelerator.memdomain.backend.banks.SramWriteIO
import framework.system.accelerator.memdomain.frontend.outside_channel.dma.{BBReadRequest, BBReadResponse}

package framework.system.accelerator.memdomain.backend.privatepath

import chisel3._
import chisel3.util._
import chisel3.experimental.hierarchy.{instantiable, public, Instance, Instantiate}
import framework.system.accelerator.memdomain.frontend.outside_channel.MemConfigerIO
import framework.system.accelerator.memdomain.backend.{MTraceDPI, MemRequestIO}
import framework.system.accelerator.memdomain.backend.accpipe.AccPipe
import framework.system.accelerator.memdomain.backend.banks.SramBank

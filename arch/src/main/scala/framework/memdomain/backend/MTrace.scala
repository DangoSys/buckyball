...
// Write generation is observed before the request reaches the SPM backend.
// Together with MTraceDPI arrival events this supplies the two counters used
// by DiffTest-N's Bank-Stable Boundary.

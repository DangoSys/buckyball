...
package framework.core.rocket.id
...
class RVVRoCCDecode(implicit val p: Parameters) extends DecodeConstants with ScalarOpConstants with MemoryOpConstants {
  ...
  private val vcfgSigs:    List[BitPat] =
    List(Y, N, Y, N, N, N, N, Y, A2_X, A1_X, IMM_X, DW_X, FN_X, N, M_X, N, N, N, N, N, N, Y, CSR.N, N, N, N, N)
  private val vcfgImmSigs: List[BitPat] =
    List(Y, N, Y, N, N, N, N, N, A2_X, A1_X, IMM_X, DW_X, FN_X, N, M_X, N, N, N, N, N, N, Y, CSR.N, N, N, N, N)

...
config = {
  ...
  "emits": ["firesim.build", "firesim.complete", "firesim.error"],
  "flows": ["firesim"],
}
...
# ==================================================================================
  ...
  result = stream_run_logger(cmd=command, logger=context.logger, stdout_prefix="firesim buildbitstream", stderr_prefix="firesim buildbitstream")
...
# ==================================================================================
  if result.returncode == 0:
    ...
    await context.emit({"topic": "firesim.error", "data": {**data, "task": "firesim", "result": failure_result, "returncode": result.returncode}})

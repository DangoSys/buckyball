...
# ==================================================================================
  ...
  result = stream_run_logger(cmd=command, logger=context.logger, cwd=bbdir, stdout_prefix="uvm build dut", stderr_prefix="uvm build dut")
...
# ==================================================================================
  ...
  if result.returncode == 0:
    await context.emit({"topic": "uvm.builddut.complete", "data": {**data, "task": "builddut", "result": success_result}})
  else:
    await context.emit({"topic": "uvm.builddut.error", "data": {**data, "task": "builddut", "result": failure_result}})

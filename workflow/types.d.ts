...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'make build': EventHandler<never, never>
    ...
    'UVM Build': ApiRouteHandler<Record<string, unknown>, unknown, { topic: 'uvm.build'; data: never }>
    'UVM Build DUT': ApiRouteHandler<Record<string, unknown>, unknown, { topic: 'uvm.builddut'; data: never }>

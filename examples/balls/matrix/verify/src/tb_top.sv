module tb_top;
  ...
  MatrixBall dut (
      ...
      .io_bankRead_1_bank_id(intf.bank_read_bank_id[1][3:0]),
      .io_bankRead_1_rob_id(intf.bank_read_rob_id[1]),
      .io_bankRead_1_group_id(intf.bank_read_group_id[1][3:0]),
      ...
      .io_bankWrite_1_bank_id(intf.bank_write_bank_id[1][3:0]),
      .io_bankWrite_1_rob_id(intf.bank_write_rob_id[1]),
      .io_bankWrite_1_group_id(intf.bank_write_group_id[1][3:0]),
      .io_bankWrite_1_io_req_ready(intf.bank_write_req_ready[1]),
      .io_bankWrite_1_io_req_valid(intf.bank_write_req_valid[1]),
      .io_bankWrite_1_io_req_bits_addr(intf.bank_write_req_addr[1]),
      .io_bankWrite_1_io_req_bits_mask_0(intf.bank_write_req_mask[1][0]),
      .io_bankWrite_1_io_req_bits_mask_1(intf.bank_write_req_mask[1][1]),
      .io_bankWrite_1_io_req_bits_mask_2(intf.bank_write_req_mask[1][2]),
      .io_bankWrite_1_io_req_bits_mask_3(intf.bank_write_req_mask[1][3]),
      .io_bankWrite_1_io_req_bits_mask_4(intf.bank_write_req_mask[1][4]),
      .io_bankWrite_1_io_req_bits_mask_5(intf.bank_write_req_mask[1][5]),
      .io_bankWrite_1_io_req_bits_mask_6(intf.bank_write_req_mask[1][6]),
      .io_bankWrite_1_io_req_bits_mask_7(intf.bank_write_req_mask[1][7]),
      .io_bankWrite_1_io_req_bits_mask_8(intf.bank_write_req_mask[1][8]),
      .io_bankWrite_1_io_req_bits_mask_9(intf.bank_write_req_mask[1][9]),
      .io_bankWrite_1_io_req_bits_mask_10(intf.bank_write_req_mask[1][10]),
      .io_bankWrite_1_io_req_bits_mask_11(intf.bank_write_req_mask[1][11]),
      .io_bankWrite_1_io_req_bits_mask_12(intf.bank_write_req_mask[1][12]),
      .io_bankWrite_1_io_req_bits_mask_13(intf.bank_write_req_mask[1][13]),
      .io_bankWrite_1_io_req_bits_mask_14(intf.bank_write_req_mask[1][14]),
      .io_bankWrite_1_io_req_bits_mask_15(intf.bank_write_req_mask[1][15]),
      .io_bankWrite_1_io_req_bits_data(intf.bank_write_req_data[1]),

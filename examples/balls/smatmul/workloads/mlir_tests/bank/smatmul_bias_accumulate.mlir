...
func.func @main() -> i8 {
  ...
  %loaded_b1 = buckyball.bank_mvin %weight1 %b1_bank %depth16 %stride
      : memref<16x16xi8> i64 i64 i64
  %bias_state = buckyball.bank_smatmul_bias %loaded_bias : i64
  %partial = buckyball.bank_smatmul %loaded_a0 %loaded_b0 %result_bank %config
      {last = false} : i64 i64 i64 i64
  %result = buckyball.bank_smatmul %loaded_a1 %loaded_b1 %partial %config
      {first = false} : i64 i64 i64 i64

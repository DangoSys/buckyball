...
func.func private @check_result(memref<32x8xi32>) -> ()

func.func @main() -> i8 {
  %zero_i8 = arith.constant 0 : i8
  %one_i8 = arith.constant 1 : i8
  %zero_i32 = arith.constant 0 : i32
  %input_depth = arith.constant 16 : i64
  %output_depth = arith.constant 32 : i64

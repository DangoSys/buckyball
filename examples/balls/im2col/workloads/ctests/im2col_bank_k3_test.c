...
/* Fill exactly one bank: 34x34 k3 -> 1024 output rows. */
enum { ITER = 34, K = 3, STRIDE = 1, PAD = 0, LANES = 16, SEED = 0x33 };
enum {
...
int main(void) {
  ...
  if (compare_i8_matrices(out, exp, OUT_ROWS, LANES)) {
    printf("im2col bank k3 34x34 PASSED\n");
    return 0;
  }
  printf("im2col bank k3 34x34 FAILED\n");
  return 1;
}

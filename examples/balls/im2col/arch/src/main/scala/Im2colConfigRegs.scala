...
class Im2colConfigRegs(
  ...
  val io = IO(new Bundle {
    ...
    val rBank       = Output(UInt(b.memDomain.vbankIdWidth.W))
    val wBank       = Output(UInt(b.memDomain.vbankIdWidth.W))
  ...
  private val rBank       = RegInit(0.U(b.memDomain.vbankIdWidth.W))
  private val wBank       = RegInit(0.U(b.memDomain.vbankIdWidth.W))

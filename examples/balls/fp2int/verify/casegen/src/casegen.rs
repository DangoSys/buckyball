...
pub fn gen_case(index: u32, bid: u32) -> Fp2IntCase {
    match index {
        ...
        _ => panic!("fp2int: unsupported directed case {index}"),
    }
}
...
fn zero_i8_case(bid: u32) -> Fp2IntCase {
    Fp2IntCase {
        cmd: Fp2IntCmd {
            bid,
            iter: 1,
...
fn rounding_i8_case(bid: u32) -> Fp2IntCase {
    let vals: [u32; 16] = [
...
fn rows_i8_case(bid: u32) -> Fp2IntCase {
    let vals: [u32; 32] = [
...
fn scale_rows_i8_case(bid: u32) -> Fp2IntCase {
    let vals: [u32; 32] = [
...
fn stream_1x4_case(bid: u32) -> Fp2IntCase {
...
fn stream_2x2_case(bid: u32) -> Fp2IntCase {
    let mut case = directed_i8_case(bid);
    case.cmd.iter = 2;
    case.cmd.op1_col = 2;
    case.cmd.rob_id = 8;
...
fn stream_8x1_case(bid: u32) -> Fp2IntCase {

...
#[no_mangle]
pub extern "C" fn fp2int_quant_scale_bits(da_bits: u32) -> u32 {
    model::fp32_divide(1.0f32.to_bits(), da_bits)
}

#[no_mangle]
pub extern "C" fn fp2int_case_load(index: u32, bid: u32) -> i32 {
...
pub extern "C" fn fp2int_case_cmd(out_ptr: *mut Fp2IntCmd) {
    current_case(|case| unsafe {
        ...
        cmd.da_bits = model::fp2int_da_bits(&case.input_words);
        *out_ptr = cmd;
    });
}
...
mod tests {
    ...
    fn dpi_load_then_cmd_and_words() {
        assert_eq!(fp2int_case_load(0, 3), 0);

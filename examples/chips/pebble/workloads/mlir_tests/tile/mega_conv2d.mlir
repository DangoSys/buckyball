...
func.func @main() -> i8 {
  ...
  %conv_weight = memref.alloc() alignment = 64 : memref<3x3x2x16xi8>
  ...
  linalg.fill ins(%one_i8 : i8) outs(%conv_weight : memref<3x3x2x16xi8>)
  ...
  tile.mega_kernel %input %output
    ...
    tile.mega_conv2d %input %conv_weight %conv_bias %conv_scale %lut
        %intermediate {activation = 1 : i64, outputScale = 1.0 : f32,
                       padHigh = 1 : i64, padLow = 1 : i64, stride = 1 : i64}
        : memref<1x4x4x2xi8> memref<3x3x2x16xi8> memref<16xi32>
  ...
  memref.dealloc %conv_weight : memref<3x3x2x16xi8>

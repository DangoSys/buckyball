//===- LowerBuckyballPass.cpp - Prefill Buckyball lowering pass -----------===//
...
public:
  ...
  StringRef getDescription() const final {
    return "Lower Prefill Buckyball dialect ops.";
  }
...
public:
  ...
  StringRef getDescription() const final {
    return "Lower Prefill bank-SSA and Buckyball ops to intrinsic ops.";
  }
...
public:
  ...
  StringRef getDescription() const final {
    return "Lower Prefill Buckyball intrinsic ops to the rushB host ABI.";
  }

//===- AssignPhysicalBanksPass.cpp - Decode physical bank assignment ------===//
...
public:
  ...
  StringRef getDescription() const final {
    return "Assign physical banks for Decode bank-SSA ops.";
  }
  ...
  void runOnOperation() override {
    ...
    mlir::buddy::populateTransposeBallAssignPhysicalBankPatterns(patterns,
                                                                 state);
    mlir::buddy::populateVecBallAssignPhysicalBankPatterns(patterns, state);

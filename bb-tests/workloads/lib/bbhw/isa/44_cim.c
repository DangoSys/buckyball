...
const InstructionConfig cim_config = {
    ...
    .rs2_fields = (BitFieldConfig[]){
        ...
        // Encode: rows[15:0], cols[31:16], op_type[35:32]
        {"rows", 25, 40},
        {"cols", 41, 56},
        {"op_type", 57, 60},
        {NULL, 0, 0}}};
...
// Encode in special: rows[15:0] = special[15:0], cols[15:0] = special[31:16], op_type[3:0] = special[35:32]
// In rs2: rows in rs2[39:24], cols in rs2[55:40], op_type in rs2[59:56]

...
#define _MM_MERGE_i64(op1, op2, op3, vl)                                       \
  __riscv_vmerge_vvm_i64m1(op1, op2, op3, vl)
#define _MM_MERGE_i32(op1, op2, op3, vl)                                       \
  __riscv_vmerge_vvm_i32m1(op1, op2, op3, vl)
...
#define _MM_MERGE_f64(op1, op2, op3, vl)                                       \
  __riscv_vmerge_vvm_f64m1(op1, op2, op3, vl)
#define _MM_MERGE_f32(op1, op2, op3, vl)                                       \
  __riscv_vmerge_vvm_f32m1(op1, op2, op3, vl)
...
#define _MM_MACC_f64(op1, op2, op3, vl)                                        \
  __riscv_vfmacc_vv_f64m1(op1, op2, op3, vl)
#define _MM_MACC_f32(op1, op2, op3, vl)                                        \
  __riscv_vfmacc_vv_f32m1(op1, op2, op3, vl)

#define _MM_MADD_f64(op1, op2, op3, vl)                                        \
  __riscv_vfmadd_vv_f64m1(op1, op2, op3, vl)
#define _MM_MADD_f32(op1, op2, op3, vl)                                        \
  __riscv_vfmadd_vv_f32m1(op1, op2, op3, vl)

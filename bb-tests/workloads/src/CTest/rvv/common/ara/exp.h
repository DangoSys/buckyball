...
#define EXP_IMPL(t, w, l, b, c1, c2)                                           \
  ...
  inline vfloat##w##m##l##_t __exp_f##w##m##l(vfloat##w##m##l##_t x,           \
                                              size_t gvl) {                    \
    ...
    imm0 = __riscv_vadd_vv_i##w##m##l(                                         \
        imm0, __riscv_vmv_v_x_i##w##m##l(c1, gvl), gvl);                       \
    imm0 = __riscv_vsll_vv_i##w##m##l(                                         \
        imm0, __riscv_vmv_v_x_u##w##m##l(c2, gvl), gvl);                       \
                                                                               \

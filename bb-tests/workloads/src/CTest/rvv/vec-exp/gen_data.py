...
emit("exponents_f64", exponents_f64, "32")
emit("results_f64", results_f64, "32")
emit("gold_results_f64", gold_results_f64, "32")
emit("N_f32", np.array(N_f32, dtype=np.uint32))
emit("exponents_f32", exponents_f32, "32")
emit("results_f32", results_f32, "32")
emit("gold_results_f32", gold_results_f32, "32")

...
#define COS64_INLINE(m, md)                                                    \
  ...
  static inline vfloat64m##m##_t __cos_f64m##m(vfloat64m##m##_t x,             \
                                               size_t gvl) {                   \
    ...
    emm2 = __riscv_vmerge_vxm_i64m##m(zv, 0xffffffffffffffff, xMask, gvl);     \
                                                                               \
    vfloat64m##m##_t sign_bit =                                                \
        __riscv_vreinterpret_v_i64m##m##_f64m##m(emm0);                        \
    vfloat64m##m##_t poly_mask =                                               \
        __riscv_vreinterpret_v_i64m##m##_f64m##m(emm2);                        \
                                                                               \
...
#define COS32_INLINE(m, md)                                                    \
  ...
  static inline vfloat32m##m##_t __cos_f32m##m(vfloat32m##m##_t x,             \
                                               size_t gvl) {                   \
    ...
    emm2 = __riscv_vmerge_vxm_i32m##m(zv, 0xffffffff, xMask, gvl);             \
                                                                               \
    vfloat32m##m##_t sign_bit =                                                \
        __riscv_vreinterpret_v_i32m##m##_f32m##m(emm0);                        \
    vfloat32m##m##_t poly_mask =                                               \
        __riscv_vreinterpret_v_i32m##m##_f32m##m(emm2);                        \
                                                                               \
    /* The magic pass: "Extended precision modular arithmetic"                 \
       x = ((x - y * DP1) - y * DP2) - y * DP3; */                             \
                                                                               \

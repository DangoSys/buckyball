...
static int verify_short(int n, const volatile int16_t *test,
                        const int16_t *verify) {
  int i;
...
void vec_conditional(size_t n, int8_t x[], int16_t a[], int16_t b[],
                     int16_t z[]);
...
int main(int argc, char *argv[]) {
  ...
  vec_conditional(DATA_SIZE, input1_data, input2_data, input3_data,
                  results_data);
#endif

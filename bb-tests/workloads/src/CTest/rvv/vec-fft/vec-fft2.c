...
void fft2(float Xr[], float Xi[], const float Wr[], const float Wi[], size_t N,
          size_t M) {
  {
    size_t N1, N2;
    float *end;
    ...
    for (N1 = N; N1 > 4;) {
      ...
      do {
        ...
        do {
          ...
          __asm__ __volatile__("vle32.v v8,  %0"
                               "\n\t" // ar
                               "vle32.v v12, %1"
                               "\n\t" // br
                               "vle32.v v16, %2"
...

  {
    ...
    do {
      size_t vl;
      __asm__ __volatile__("vsetvli %0, %1, e32, m2, ta, ma"
                           "\n\t"
                           : "=r"(vl)
                           : "r"(n));

      __asm__ __volatile__("vlseg4e32.v v0, %0"
                           "\n\t"
                           "vlseg4e32.v v8, %1"
                           "\n\t"
    ...
    do {
      ...
      __asm__ __volatile__("vlseg2e32.v v0, %0"
                           "\n\t"
                           "vlseg2e32.v v8, %1"
                           "\n\t"

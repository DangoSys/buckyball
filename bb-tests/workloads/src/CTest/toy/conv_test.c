...
void hw_conv(const char *test_name, elem_t *ifmap, elem_t *weight, elem_t *ofmap,
             int in_h, int in_w, int kernel_h, int kernel_w) {
  // Input feature map in spad bank 0, weights in spad bank 1, output in spad bank 2
...
int run_test(const char *test_name, elem_t *ifmap, elem_t *weight, elem_t *ofmap,
             int in_h, int in_w, int kernel_h, int kernel_w) {

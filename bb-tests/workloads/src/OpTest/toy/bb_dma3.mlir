...
func.func @main() -> i8 {
  ...
  buckyball.bb_print_memref %arrayA_head : memref<2x16xi8, strided<[16, 1]>>
  buckyball.bb_print_memref %arrayA_tail : memref<2x16xi8, strided<[16, 1], offset: 16336>>
  ...
  // CHECK: mvin
  buckyball.bb_mvin %arrayA %bankId %depth %stride : memref<1023x16xi8> i64 i64 i64 i64

  // Step 2: long write - write large amount of data from scratchpad to memory
  // CHECK: mvout
  buckyball.bb_mvout %arrayB %bankId %depth %stride : memref<1023x16xi8> i64 i64 i64 i64
  ...
  buckyball.bb_print_memref %arrayB_head_after : memref<2x16xi8, strided<[16, 1]>>
  buckyball.bb_print_memref %arrayB_tail_after : memref<2x16xi8, strided<[16, 1], offset: 16336>>

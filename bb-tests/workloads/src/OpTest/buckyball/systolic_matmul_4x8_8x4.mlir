// Prototype SystolicArrayBall contract: 4x8 i8 @ 8x4 i8 -> 4x4 i32.
// The lowering must split the K dimension into two 4-wide systolic commands
...
// CHECK: buckyball.bank_systolic {{.*}} %[[C4]] %[[CFG_FIRST_OS]]
// CHECK: buckyball.bank_systolic {{.*}} %[[C4]] %[[CFG_LAST_OS]]
// CHECK: buckyball.bank_mvout {{.*}} %[[C4]]
// CHECK: buckyball.bank_systolic {{.*}} %[[C4]] %[[CFG_FIRST_WS]]
// CHECK: buckyball.bank_systolic {{.*}} %[[C4]] %[[CFG_LAST_WS]]
// CHECK: buckyball.bank_mvout {{.*}} %[[C4]]
